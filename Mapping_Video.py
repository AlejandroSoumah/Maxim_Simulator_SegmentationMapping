...
def game_loop(args):
    ...
    try:
        ...
        rgb_cam.set_attribute("image_size_x",str(1242))
        rgb_cam.set_attribute("image_size_y",str(375))
        rgb_cam.set_attribute("fov",str(90))
        rgb_cam_transform = carla.Transform(carla.Location(x=-1.5, z=2.4 , y = 0),carla.Rotation(pitch=-13))
        ...
        while True:
            ...
            if frame % 15 == 0:
                try:
                    ...
                    cv2.imwrite("Mapping_IMG_Output/curved_lane_img"+str(frame)+".png",image_rgb)
                except:
                    continue
