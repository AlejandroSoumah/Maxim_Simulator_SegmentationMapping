...
def pipeline(img,visualise=True,diagnostics = False):
    global cache
...
def create_hyp_waypoints(pts_mid_pre,Depth_Image,Ego_state,lenght):
    ...
    for x in range(1,lenght):
        input_pos_u = int(pts_mid_pre[lenght - x][1]) #x
        input_pos_v = int(pts_mid_pre[lenght - x][0]) #y
        print("input_pos_u",input_pos_u)
        print("input_pos_v",input_pos_v)
