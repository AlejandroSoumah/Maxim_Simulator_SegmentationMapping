...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        self._yf = yf
        self._tf = tf
        self.nine_two = (9.0/2.0)
        self.two_E_two = (2.7E1/2.0)
        self.four_E_two =(4.5E1/2.0)
    ...
    def fxf(self, p):
        ...
        t2 = p[0]*(1.1E1/2.0)
        t3 = p[1]*9.0
        t4 = p[2]*(self.nine_two)
        t5 = p[0]*(self.nine_two)
        t6 = p[1]*(self.two_E_two)
        t7 = p[2]*(self.two_E_two)
        t8 = p[3]*(self.nine_two)
        t9 = t5-t6+t7-t8
        t10 = p[0]*9.0
        t11 = p[1]*(self.four_E_two)
        t12 = p[2]*1.8E1;
        t13 = t8-t10+t11-t12;
        t14 = p[3]-t2+t3-t4;
